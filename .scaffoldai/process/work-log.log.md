...
This file is not authoritative for current process rules. Current process rules live in `.scaffoldai/process/runbook.process.md`, `.scaffoldai/process/manual-execution-flow.process.md`, and the packet execution docs.
...
FILES
- `.scaffoldai/agents/gatekeeper.agent.md` (updated §2 binding status, replaced §11 with Current System Capability)
- `.scaffoldai/process/process-flow-map-and-dry-run-contract.process.md` (added §6 impl note, replaced §9 with Soft Gate Phase table, added §10)
- `.scaffoldai/process/work-log.md` (this entry and backfill entries)
...
SUMMARY
- Added `.scaffoldai/templates/sdc-implementation-task.md` as a reusable copy-paste SDC template for future implementation tasks.
...
FILES
- .scaffoldai/templates/sdc-implementation-task.md
...
SUMMARY
- Added `.scaffoldai/templates/work-packet-v3.md` — a reusable WORK_PACKET template with explicit idempotency detection.
