...
| Product-oriented commands | `src/commands/new-guid.cmd.consync.js`, `src/commands/list-guid.cmd.consync.js`, `src/commands/show-guid.cmd.consync.js`, `src/scaffoldai/commands/portable.process.scaffoldai.js`, selected sandbox commands | Candidate product-facing commands, depending on future product framing. |
