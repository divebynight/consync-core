...
This file is not authoritative for current verification rules. Current verification rules live in `.scaffoldai/verification/verification-ladder.md`, test configs, and runtime verification surfaces.
