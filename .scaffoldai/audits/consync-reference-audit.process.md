...
**Key finding:** Every runtime code path that hardcodes a `.consync/` location reads or writes exclusively from `.consync/state/` or `.consync/streams/` — both classified as **BRIDGE**. Zero runtime code reads `.scaffoldai/process/`, `.scaffoldai/agents/`, `.scaffoldai/skills/`, `.scaffoldai/contracts/`, or `.scaffoldai/templates/` at runtime. The PROCESS zone is entirely safe to relocate without touching any runtime code.
...
| `README.md` | DOCS | Navigation link | Links to `.scaffoldai/process/` docs and `.consync/examples/`; no code path | LOW |
| `AGENTS.md` | DOCS | Navigation text | References `.scaffoldai/agents/`, `.scaffoldai/skills/`, `.consync/state/`; no code path | LOW |
...
| `.github/prompts/run_closeout.prompt.md` | BRIDGE + PROCESS | Prompt file read | AI prompt reads `.consync/state/handoff.md` (BRIDGE) and `.scaffoldai/skills/closeout-agent.md` (PROCESS) at prompt execution time | MEDIUM |
| `.github/prompts/run_next_action.prompt.md` | BRIDGE + PROCESS | Prompt file read | AI prompt reads `.consync/state/*` (BRIDGE) and `.scaffoldai/process/runbook.process.md` (PROCESS) | MEDIUM |
...
|---|---|---|
| `README.md` | `.scaffoldai/process/`, `.consync/examples/` | Operator confusion only |
| `AGENTS.md` | `.scaffoldai/agents/`, `.scaffoldai/skills/`, `.consync/state/` | Operator confusion only |
...
| `src/lib/gatekeeperDecision.js` (comment) | `.scaffoldai/agents/gatekeeper.agent.md` | Doc comment only; zero runtime impact |
| All `.scaffoldai/process/` cross-references | `.consync/` internal | Internal doc navigation; no code impact |
...
- Mix BRIDGE references (`.consync/state/handoff.md`) with PROCESS references (`.scaffoldai/skills/closeout-agent.md`, `runbook.process.md`).
