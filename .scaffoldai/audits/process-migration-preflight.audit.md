...
Prior audit: `.scaffoldai/audits/consync-reference-audit.process.md`
...
| `.github/prompts/run_next_action.prompt.md` | `.scaffoldai/process/runbook.process.md` (line 4 — orientation reference) | PROMPT_ONLY | NO | MEDIUM |
| `.github/copilot-instructions.md` | `.scaffoldai/process/runbook.process.md`, `.scaffoldai/agents/`, `.scaffoldai/skills/`, `.scaffoldai/agents/entry-adapter.agent.md` (lines 7, 9, 11, 71) | PROMPT_ONLY | NO | MEDIUM |
| `.github/agents/consync-process.agent.md` | `.scaffoldai/process/` (line 23 — orientation text) | DOC_ONLY | NO | LOW |
| `README.md` | `.scaffoldai/process/` (lines 62, 69, 70, 83, 85 — navigation links) | DOC_ONLY | NO | LOW |
| `README.md` | `.scaffoldai/agents/`, `.scaffoldai/skills/` (line 85 — orientation text) | DOC_ONLY | NO | LOW |
| `AGENTS.md` | `.scaffoldai/agents/`, `.scaffoldai/skills/` (lines 8, 9, 15, 17, 18 — authority boundary text) | DOC_ONLY | NO | LOW |
| `.consync/docs/START_HERE.md` | `.scaffoldai/process/`, `.scaffoldai/agents/`, `.scaffoldai/skills/`, `.scaffoldai/contracts/`, `.scaffoldai/templates/`, `.scaffoldai/verification/`, `.scaffoldai/planning/` (lines 40–120 — navigation table, ~20 path references) | DOC_ONLY | NO | MEDIUM |
...
| `.scaffoldai/process/runbook.process.md` | Internal cross-links to other process docs, agents, skills, contracts (lines 14, 26–27, 87–88, 272–283) | DOC_ONLY (internal) | NO | LOW |
| `.scaffoldai/process/production-change-packet-rules.process.md` | Cross-links to templates, verification, process docs (lines 74, 98, 100, 104–105, 135–137) | DOC_ONLY (internal) | NO | LOW |
| `.scaffoldai/process/feature-planning-and-packetization.process.md` | Cross-link to `.scaffoldai/process/production-change-packet-rules.md` (line 237) | DOC_ONLY (internal) | NO | LOW |
| `.scaffoldai/templates/work-packet-v3.md` | Cross-links to process, skills, verification (lines 87, 124, 194–196) | DOC_ONLY (internal) | NO | LOW |
| `.scaffoldai/skills/closeout-agent.md` | Cross-links to `.scaffoldai/process/work-log.log.md` (lines 41, 66) | DOC_ONLY (internal) | NO | LOW |
| `.scaffoldai/skills/ingestion-gatekeeper.md` | Cross-links to `.scaffoldai/planning/`, `.scaffoldai/process/work-log.log.md` (lines 45, 53, 57, 61, 106–107) | DOC_ONLY (internal) | NO | LOW |
...
**Risk: MEDIUM–HIGH**  
Line 15 contains `.scaffoldai/skills/closeout-agent.md` as a likely `#file:` inclusion.
...
[ ] 7. PROMPT — update .github/prompts/run_closeout.prompt.md
       Change all 3 occurrences of .scaffoldai/skills/closeout-agent.md
       To: .scaffoldai/skills/closeout-agent.md

[ ] 8. PROMPT — update .github/prompts/run_next_action.prompt.md
       Change: .scaffoldai/process/runbook.process.md
       To: .scaffoldai/process/runbook.process.md

[ ] 9. PROMPT — update .github/copilot-instructions.md
       Replace all PROCESS zone paths:
       .scaffoldai/process/runbook.process.md    → .scaffoldai/process/runbook.process.md
       .scaffoldai/agents/                       → .scaffoldai/agents/
       .scaffoldai/skills/                       → .scaffoldai/skills/
       .scaffoldai/agents/entry-adapter.agent.md → .scaffoldai/agents/entry-adapter.agent.md

[ ] 10. PROMPT — update .github/agents/consync-process.agent.md
        Change: .scaffoldai/process/ → .scaffoldai/process/

[ ] 11. DOC — update README.md
        Replace all .scaffoldai/process/, .scaffoldai/agents/, .scaffoldai/skills/ paths
        with .scaffoldai/ equivalents

[ ] 12. DOC — update AGENTS.md
        Replace all .scaffoldai/agents/, .scaffoldai/skills/ paths
        with .scaffoldai/ equivalents

[ ] 13. DOC — update .consync/docs/START_HERE.md
        Bulk replace .scaffoldai/process/ → .scaffoldai/process/
                     .scaffoldai/agents/  → .scaffoldai/agents/
                     .scaffoldai/skills/  → .scaffoldai/skills/
                     .scaffoldai/contracts/ → .scaffoldai/contracts/
                     .scaffoldai/templates/ → .scaffoldai/templates/
...
[ ] 15. DOC — bulk replace .scaffoldai/process/ etc. inside all moved PROCESS docs
