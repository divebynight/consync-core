...
- `.consync/process/runbook.process.md` or a compact pointer to it
...
- `.consync/process/runbook.process.md` explains which local files should be read first during re-entry
