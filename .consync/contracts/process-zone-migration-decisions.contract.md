...
Related plan:
`.consync/planning/process-zone-migration.plan.md`
...
top-level architecture contracts remain temporarily in `.consync/contracts/`
...
All contracts in `.consync/contracts/` are ScaffoldAI-owned PROCESS surfaces —
