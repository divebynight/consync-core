...
- `.consync/.agents/skills/` contains reusable procedures/skills used by agents; it is not the primary role-definition surface.
...
- Use the Closeout agent after human-approved completed work to verify tests, docs, integrity, and commit readiness. Its current bound process surface is `.consync/.agents/skills/closeout-agent.md`.
