...
- `src/mcp/` is the **local trusted surface** with fuller capabilities (8 tools including diagnostics)
- `src/mcp-readonly/` is the **constrained compatibility surface** with minimal exposure (2 tools, no diagnostics)
