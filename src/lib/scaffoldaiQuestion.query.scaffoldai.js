...
function checkActiveStreamExists(repoRoot) {
  const STATE_DIR = path.join(repoRoot, ".scaffoldai", "state");
...
function checkNextActionAmbiguity(repoRoot) {
  const STATE_DIR = path.join(repoRoot, ".scaffoldai", "state");
...
function checkRequiredScripts(repoRoot) {
...
function checkExecutionClassBoundary(repoRoot) {
...
function checkTmpBoundary(repoRoot) {
...
// -----------------------------------------------------------------------
// Main question gathering function
// -----------------------------------------------------------------------
 ...
 * }}
 */
function gatherQuestions(repoRoot) {
  const STATE_DIR = path.join(repoRoot, ".scaffoldai", "state");
  ...
  const questions = [];
  const checks = [
    checkStateFilesPresent(repoRoot),
    checkContractCoherence(contract),
    checkAllowedPacketTypes(contract),
    checkVerifyCommandResolvable(contract),
    checkActiveStreamExists(repoRoot),
    checkNextActionAmbiguity(repoRoot),
    checkRequiredScripts(repoRoot),
    checkTmpBoundary(repoRoot),
    checkExecutionClassBoundary(repoRoot),
  ];
