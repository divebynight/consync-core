...
description: Checks package-loop alignment across next-action, handoff, stream state, and process docs. Reports mismatches and protocol drift without modifying files.
---
...
1. PACKAGE IDENTITY
- Confirm TYPE and PACKAGE remain consistent across next-action, handoff, and any referenced stream-local state
- Flag mismatches, duplicated headers, or stale package labels

2. LOOP STATE ALIGNMENT
- Check whether next-action, handoff, and active foreground stream appear to describe the same current phase of work
